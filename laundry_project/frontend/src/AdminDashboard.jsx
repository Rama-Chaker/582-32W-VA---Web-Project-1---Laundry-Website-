        ...
        <div className="admin-container">
            ...
            <aside className="admin-sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    >
                        <Shirt size={18} className="nav-icon" />
                        Orders
                    </button>
            ...
            <main className="admin-main">
                <header className="admin-header">
                    <h1>
                        ...
                        {activeTab === "Expenses" && "Expenses & Finance"}
                ...
                {activeTab === "Orders" && (
                    <AdminOrders onOrderUpdated={loadDashboardData} />
                )}

                {/* TAB 3: EXPENSES MANAGEMENT VIEW */}
                {activeTab === "Expenses" && (
                    <AdminExpenses
                ...
                {/* TAB 4: CUSTOMERS DIRECTORY VIEW */}
